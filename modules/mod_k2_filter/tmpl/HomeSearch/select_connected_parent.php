...
?>
	...
	<div class="k2filter-field-select">
		...
		<select class="turnintodropdown_demo2 connected" name="searchword<?php echo $field->id; ?>" <?php if($onchange) : ?>onchange="submit_form_<?php echo $module->id; ?>()"<?php endif; ?> rel="<?php echo $field->name; ?>">
