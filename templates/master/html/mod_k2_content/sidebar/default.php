  ...
  <ul>
	...
	<!-- Image -->
      ...
      <div class="moduleItemIntrotext">
	      ...
	      <a class="mod_image moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
...
<!-- Title -->
      ...
      <a class="title moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
      <?php endif; ?>
      </div>
<!-- Author -->
      <?php if($params->get('itemAuthor')): ?>
      <div class="mod_author moduleItemAuthor">
