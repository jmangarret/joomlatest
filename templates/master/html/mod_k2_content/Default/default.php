...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <div class="container no-padding">
    ...
    <div class="col-md-4 col-sm-6 post<?php if(count($items)==$key+1) echo ' lastItem'; ?>">
       <div class="entry-date">
	                   <?php if($params->get('itemDateCreated')): ?>
							<div class="date">
								<h2><?php echo JHTML::_('date', $item->created, 'd'); ?></h2>
								<h4><?php echo JHTML::_('date', $item->created, 'M'); ?></h4>
							</div>
						<?php endif ?> 
						<div class="icon">
      ...
      <div class="entry-header">
		<a class="moduleItemTitle entry-title" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
	  </div>	
      <?php endif; ?>
	  ...
	  <div class="post-date">
	    ...
	    <?php if($params->get('itemDateCreated')): ?>
			<span class="entry-date"><?php echo JHTML::_('date', $item->created, 'M'.' d,'.' Y'); ?></span>
		<?php endif; ?>
		...
		<?php if($params->get('itemCommentsCounter') && $componentParams->get('comments')): ?>
            <span class="comments-link">		
				...
				<?php else: ?>
					...
					<?php else: ?>
					<a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>">
						<?php echo $item->numOfComments; ?> <?php echo JText::_('K2_COMMENT'); ?>
					</a>
					<?php endif; ?>
				<?php endif; ?>
			</span>	
		...
		<?php if($params->get('itemHits')): ?>
			<span class="post-views"><i class="fa fa-heart"></i> <?php echo $item->hits; ?></span>
		<?php endif; ?>
	  </div>
      ...
      <?php endif; ?>
			...
			<a class="moduleItemReadMore read-more" href="<?php echo $item->link; ?>">
