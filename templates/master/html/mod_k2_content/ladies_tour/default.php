...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="col-md-4 col-sm-4 col-xs-12 <?php echo ($key%2) ? "odd no-padding-left" : "even no-padding-left"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      <div class="ladies_inner">
