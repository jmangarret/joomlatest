...
<div class="catItemView grid_view col-md-4 col-sm-6 col-xs-12 group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
	  ...
	  <!-- Item Image -->
	  <div class="listing_left col-md-12 col-sm-12 col-xs-12 no-padding">
	  ...
	  <?php endif; ?>
	<div class="details">
	<div class="listing_middle col-md-12 col-sm-12 col-xs-12 no-padding"> 
	...
	<div class="header_title">
	  ...
	  <!-- Location extra fields -->
			...
			<?php if($extraField->value != ''): ?>
			 <?php if($extraField->name == 'Airline'): ?>
	 ...
	 <?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)): ?>
	  ...
	  <div class="catItemExtraFields">
	  	<ul>
			<?php foreach ($this->item->extra_fields as $key=>$extraField): ?>
			<?php if($extraField->value != ''): ?>
			<?php if(($extraField->name == 'Base fare') OR ($extraField->name == 'Room')): ?>
...
<!--  <div class="catHeaderRight">
  ...
  <?php echo $this->item->event->K2AfterDisplay; ?>
	...
	<div class="catItemRatingBlock">
		...
		<div class="itemRatingForm">
			...
			<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog"><?php echo $this->item->numOfvotes; ?>
  ...
  <div class="catItemBody col-md-12 col-xs-12 col-sm-12">
