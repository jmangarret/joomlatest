...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" name="userform" autocomplete="off" class="form-validate edit_profile">
	...
	<div id="k2Container" class="k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					...
					<label for="del_image" class="del_image_desc"><?php echo JText::_('K2_CHECK_THIS_BOX_TO_DELETE_CURRENT_IMAGE_OR_JUST_UPLOAD_A_NEW_IMAGE_TO_REPLACE_THE_EXISTING_ONE'); ?></label>
		...
		<br>
		<div class="k2AccountPageUpdate save">
			<button class="master_btn button validate" type="submit" onclick="submitbutton( this.form );return false;">
