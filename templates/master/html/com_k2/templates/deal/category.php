			...
			<li class="sort-by-name">
			  <span><?php echo JText::_('K2_NAME'); ?></span>
			   ...
			   <div class="sorting_data">
				...
				<a title="Descending order"><i class="fa fa-caret-down"></i></a> 
				
				<?php } else{ ?>
				<a title="Ascending Order" class="ascending"><i class="fa fa-caret-up"></i></a>
		...
		<ul class="swap-tiles clearfix block-sm">
		  <?php if(isset($_REQUEST['display'])){ ?>
				<?php if($_REQUEST['display']=='list'){ ?>
				 <li class="swap-grid">
					<a onclick="showGridViewJS()" title="<?php echo JText::_('K2_GRID_VIEW'); ?>"><i class="fa fa-th-large"></i></a> 
				 </li>
				  <li class="swap-list active">										 
					<a title="<?php echo JText::_('K2_LIST_VIEW'); ?>" class="ListView"><i class="fa fa-list"></i></a>
				  </li>	
					<?php }else{ ?>
					<li class="swap-grid active">
						<a title="<?php echo JText::_('K2_GRID_VIEW'); ?>"><i class="fa fa-th-large"></i></a> 
					</li>
					<li class="swap-list">
						<a onclick="showListViewJS()" title="<?php echo JText::_('K2_LIST_VIEW'); ?>" class="ListView"><i class="fa fa-list"></i></a>
					</li>	
					<?php } ?>
					<?php }else{ ?>
					 <li class="swap-grid">
