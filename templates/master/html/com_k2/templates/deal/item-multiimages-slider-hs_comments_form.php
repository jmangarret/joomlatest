...
<h3 class="comment_title"><?php echo JText::_('K2_LEAVE_A_COMMENT') ?></h3>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" id="comment-form" class="form-validate">
	...
	<button type="submit" class="button master_btn" id="submitCommentButton"><?php echo JText::_('K2_SUBMIT_COMMENT'); ?>" </button>
