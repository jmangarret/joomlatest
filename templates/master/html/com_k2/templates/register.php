...
<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" id="josForm" name="josForm" class="form-validate">
	...
	<div class="componentheading k2_register_heading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		<h2><?php echo $this->escape($this->params->get('page_title')); ?></h2>
	</div>
	<?php endif; ?>
	<div id="k2Container" class="master_regi k2AccountPage">
		<table class="admintable" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					<input type="text" name="<?php echo $this->nameFieldName; ?>" id="name" placeholder="Name *" size="40" value="<?php echo $this->escape($this->user->get( 'name' )); ?>" class="inputbox required" maxlength="50" />
			...
			<tr>
				...
				<td>
					<input type="text" id="username" name="<?php echo $this->usernameFieldName; ?>" placeholder="Username *" size="40" value="<?php echo $this->escape($this->user->get( 'username' )); ?>" class="inputbox required validate-username" maxlength="25" />
			...
			<tr>
				...
				<td>
					<input type="text" id="email" placeholder="Email *" name="<?php echo $this->emailFieldName; ?>" size="40" value="<?php echo $this->escape($this->user->get( 'email' )); ?>" class="inputbox required validate-email" maxlength="100" />
			...
			<tr>
				...
				<td>
					<input type="text" id="email2" placeholder="Confirm Email *" name="jform[email2]" size="40" value="" class="inputbox required validate-email" maxlength="100" />
			...
			<tr>
				...
				<td>
					<input class="inputbox required validate-password" type="password" id="password" placeholder="Password *" name="<?php echo $this->passwordFieldName; ?>" size="40" value="" />
			...
			<tr>
				...
				<td>
					<input class="inputbox required validate-passverify" type="password" id="password2" placeholder="Confirm Password *" name="<?php echo $this->passwordVerifyFieldName; ?>" size="40" value="" />
			...
			<tr>
				...
				<td>
					<input type="file" id="image" name="image" placeholder="User image (avatar)"/>
			...
			<tr>
				...
				<td>
					<input type="text" size="50" placeholder="URL" value="<?php echo $this->K2User->url; ?>" name="url" id="url"/>
				</td>
			</tr>
		...
		<div class="k2AccountPageUpdate">
			<button class="button validate master_btn" type="submit">
